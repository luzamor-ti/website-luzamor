          ...
          return (
            ...
            >
              <div className="relative w-full">
                <Image
                  src={imageUrl}
                  alt={image.alt || `${projectTitle} - Foto ${index + 1}`}
                  width={800}
                  height={600}
              ...
              {image.caption && typeof image.caption === "string" && (
          ...
          >
            ...
            >
              <div className="relative w-full h-full flex items-center justify-center">
                <Image
                  src={buildSanityImageUrl(
                    images[selectedIndex].asset?._ref || "",
                  )}
                  alt={
                    images[selectedIndex].alt ||
                    `${projectTitle} - Foto ${selectedIndex + 1}`
                  }
                  fill
              ...
              {images[selectedIndex].caption &&
                typeof images[selectedIndex].caption === "string" && (
                  <div className="mt-4 text-center">
                    <p className="text-white text-lg">
                      {images[selectedIndex].caption as string}
                    </p>
                  </div>
                )}
